...
class UserController {
    constructor(userService = new user_service_1.default()) {
        ...
        this.update = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const user = req.body;
            const editedUser = yield this.userService.update(id, user);
            res.status(http_status_codes_1.StatusCodes.OK).json(editedUser);
        });
        this.delete = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const id = Number(req.params.id);
            yield this.userService.delete(id);
            res.status(http_status_codes_1.StatusCodes.OK).send({ message: 'User deleted' });
        });
    }
}
